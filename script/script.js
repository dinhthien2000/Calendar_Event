...
function loadCalendar() {
    ...
    const dayString = dateText.split(", ")[0]; // ngày thứ
    ...
    for (let i = 1; i <= dayInMonth + emptyDays; i++) {
        ...
        const monthVal = month + 1 < 10 ? "0" + (month + i) : month + i;
        ...
        if (i > emptyDays) {
            ...
            // Holiday 
            const holidayOffTheDay = holidays.find(e => e.hdate == dateText);
...
function print(string, variable) {
    console.log(checkArgument(string) + " " + variable);
}
